...
class MySwinFormer(nn.Module):
    ...
    def forward(self,x):
        ...
        print("cost Volume Patch shape: ",x.shape)
...
if __name__=="__main__":
    ...
    swin_former = MySwinFormer(pretrain_image_size=(320,640),
                               patch_size=(4,4),in_chans=3,embed_dim=96,
                               norm_layer=nn.LayerNorm,
                               patch_norm=True,
                               if_absolute_embedding=True).cuda()
    
    swin_former(input_tensor)
